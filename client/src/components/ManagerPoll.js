    ...
    return (
      <div className="manager-poll-responses">
        ...
        <p className="member-form-subtitle">
          respond to the manager poll to guide your team's responses to their
          stand up survey for today ({today})
        </p>
        <div className="vertical-line" />

        <div className="manager-poll-question">
          {" "}
          {this.state.managerQuestions[0]}
        </div>
        <TextField
          fullWidth={true}
        ...
        {this.state.managerQuestions.length === 4 ? (
          <>
            <div className="linebr" />
            <div className="manager-poll-question">
              {" "}
              {this.state.managerQuestions[3]}
            </div>
            <TextField
              fullWidth={true}
              onChange={this.handleChange}
